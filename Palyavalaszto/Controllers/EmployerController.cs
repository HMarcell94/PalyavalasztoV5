    ...
    public class EmployerController : Controller
    {
        ...
        public IActionResult GetEmployer(int employerId)
        {
            ...
            var employerDto = new EmployerDto
            {
                ...
                CompanyLogo = Convert.ToBase64String(System.IO.File.ReadAllBytes(employer.CompanyLogo)),
        ...
        public IActionResult CreateEmployer([FromBody] EmployerDto employerCreate)
        {
            ...
            var employerEntity = new employer
            {
                ...
                ContactNumber = employerCreate.ContactNumber,
                CompanyURL = employerCreate.CompanyURL
            };
        ...
        public IActionResult UpdateEmployer(int employerId, [FromBody] EmployerDto employerUpdate)
        {
            ...
            employerEntity.ContactNumber = employerUpdate.ContactNumber;
            employerEntity.CompanyURL = employerUpdate.CompanyURL;
